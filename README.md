...
- Compile the images using `docker build -t debian-with-tmate -f Dockerfile-debian . && docker build -t debian-with-tmate -f Dockerfile-ubuntu .` and wait for it to be done 
